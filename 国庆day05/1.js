...
// 二、简答题
// 1. 转字符串类型的时候，有哪些限制？
// undefined，null不能用toString方法


// 2. 关于变量命名的规则有哪些
// 只能包含数字.字母和下划线  不能与数字开头 


// 3. Console.log(true&&false||true)和console.log(false || true&&false)的结果分别是什么，并解释为什么
// Console.log(true&&false||true)  //报错  Console.log   c应该要小写
// console.log(false || true&&false)   //  &&的优先级高于||  所以先比较&&  因为&&的特点是一假则假 所以得到的结果是 false||false  在比较||  而||的特点是一真则真   得到的结果是 flase
 
// 4. 将一行字符串分多行显示，有几种写法，分别是什么

// // 第一种  用引号包起来  换行后用反斜线拼接  
// // 例如:
// var str='asdf\
// asdfasdf\
// adsfas'
